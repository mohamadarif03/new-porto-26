  ...
  const certificates = [
    {
      ...
      issuer: 'Dicoding',
      image: '/certificate/dicoding-belajar machine learning untuk pemula-D-gNHk9Z.webp',
    },
    {
  ...
  return (
    <>
      ...
      <div className="social-links">
          <a href="https://www.linkedin.com/in/mohamad-arif-68402627a/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          <a href="https://github.com/mohamadarif03" target="_blank" rel="noopener noreferrer">GitHub</a>
          <a href="https://www.instagram.com/mhmdarif346/" target="_blank" rel="noopener noreferrer">Instagram</a>
      </div>
      </section>

      {/* Tech Stack Marquee — self-hosted SVG icons */}
      <section className="marquee-section">
          <div className="marquee-track">
              <div className="marquee-content">
                  <img src="/icons/php.svg" alt="PHP" width="45" height="45" loading="lazy" />
                  <img src="/icons/go.svg" alt="Go" width="45" height="45" loading="lazy" />
                  <img src="/icons/react.svg" alt="React" width="45" height="45" loading="lazy" />
                  <img src="/icons/python.svg" alt="Python" width="45" height="45" loading="lazy" />
                  <img src="/icons/pandas.svg" alt="Pandas" width="45" height="45" loading="lazy" />
                  <img src="/icons/numpy.svg" alt="Numpy" width="45" height="45" loading="lazy" />
                  <img src="/icons/typescript.svg" alt="TypeScript" width="45" height="45" loading="lazy" />
                  <img src="/icons/tailwindcss.svg" alt="Tailwind" width="45" height="45" loading="lazy" />
              </div>
              <div className="marquee-content">
                  <img src="/icons/php.svg" alt="PHP" width="45" height="45" loading="lazy" />
                  <img src="/icons/go.svg" alt="Go" width="45" height="45" loading="lazy" />
          ...
          <div className="contact-container">
              <div className="contact-left">
                  ...
                  <div className="contact-links">
                      ...
                      <a href="https://linkedin.com/in/mohamad-arif-68402627a" target="_blank" rel="noopener noreferrer" className="contact-link-item">
                          <svg viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" fill="currentColor"/></svg>
                          <span>LinkedIn</span>
                      </a>
                      <a href="https://github.com/mohamadarif03" target="_blank" rel="noopener noreferrer" className="contact-link-item">
                      ...
                      <a href="https://instagram.com/mhmdarif346/" target="_blank" rel="noopener noreferrer" className="contact-link-item">
