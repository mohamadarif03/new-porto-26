    ...
    <>
      <section className="proj-hero">
        <div className="proj-hero-inner">
          ...
          <h1 className="proj-hero-title">My <span className="proj-hero-accent">Projects</span></h1>
          <p className="proj-hero-desc">A curated collection of projects spanning web development and data science — each crafted with purpose, precision, and a passion for solving real-world problems.</p>
        </div>
      </section>
      ...
      <section className="proj-content">
        <div className="proj-content-inner">
            ...
            <div className="proj-filter-bar">
              {categories.map(cat => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                >
                  {cat === 'All' && <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>}
                  {cat === 'Web Development' && <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>}
                  {cat === 'Data Science' && <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>}
                  <span>{cat}</span>
          ...
          {filteredProjects.length === 0 && (
            <div className="proj-empty"><p>No projects found in this category yet.</p></div>
          )}
        </div>
      </section>
    </>
