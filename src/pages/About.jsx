...
function About() {
  ...
  // LinkedIn-style: group by company, each company has sub-roles
  const experiences = [
    {
      ...
      roles: [
        {
          ...
          description: 'Actively involved in a data-focused community exploring real-world machine learning and data analysis applications.',
          bullets: [
            'Explored and preprocessed real-world datasets using Python, Pandas, and NumPy for applied ML projects.',
            'Built predictive models using Scikit-learn and evaluated performance with cross-validation techniques.',
            'Contributed to internal workshops and knowledge-sharing sessions on data science fundamentals.',
          ],
    ...
    },
    {
      ...
      logo: '/exp/jobnation.png',
      totalDuration: '1 yr',
      roles: [
        {
          title: 'Web Developer',
          type: 'Freelance',
          period: 'Jan 2025 – Jan 2026 · 1 yr',
          ...
          skills: ['Laravel', 'React', 'PHP', 'REST API'],
        },
      ],
    },
    {
      company: 'PT Humma Teknologi',
      logo: '/exp/hummatech.png',
      totalDuration: '2 yrs 7 mos',
      roles: [
        {
          title: 'Mentor - Kelas Industri',
          type: 'Contract',
          period: 'Sep 2023 – Jul 2025 · 1 yr 11 mos',
          location: 'Malang, East Java, Indonesia · Remote',
          description: 'Mentored students and junior developers in web development technologies including Laravel, Java, PHP, JavaScript, and HTML.',
          bullets: [
            'Guided 30+ students through hands-on web development projects and coding exercises.',
            'Created structured curriculum materials covering Laravel, JavaScript, and modern web practices.',
            'Conducted code reviews and provided constructive feedback to accelerate student learning.',
          ],
          skills: ['Teaching', 'Laravel', 'JavaScript', 'Mentoring'],
        },
        {
          title: 'Web Developer',
          type: 'Contract',
      ...
      <section className="about-hero">
        ...
        <div className="about-bio">
          ...
          <h1 className="about-title">
            Mohamad <span className="light-text">Arif</span>
          </h1>
        ...
        <div className="about-photo-col">
          <div className="about-photo-wrapper">
            <img src="/photo.jpg" alt="Mohamad Arif" className="about-photo" />
          </div>
          ...
          <div className="about-social-row">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="about-social-link" aria-label="GitHub">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="about-social-link" aria-label="Instagram">
        ...
        <div className="about-journey-inner">
          <div className="about-journey-header">
            ...
            <h2 className="about-journey-title">
              My <span className="light-text">Journey</span>
            </h2>
            <p className="about-journey-intro">
              Here's a detailed look at what I've been building, learning, and contributing throughout my career.
            </p>
          </div>
    ...
    <div className="exp-card">
      ...
      <div className="exp-company-header">
        <div className="exp-logo-wrapper">
          <img src={experience.logo} alt={experience.company} className="exp-logo-img" />
        </div>
...
function RoleItem({ role, hasTimeline, isLast }) {
  ...
  return (
    <div className={`role-item ${hasTimeline ? 'with-line' : ''} ${isLast ? 'last' : ''}`}>
      {/* Timeline dot for multi-role companies */}
      {hasTimeline && (
